...
// Use generic type for Notion blocks since the exact type path varies by version
 ...
 */
export function chunkText(text: string, maxLength: number = NOTION_LIMITS.SAFE_PARAGRAPH_LENGTH): string[] {
