...
export const SELECTOR_REGISTRY: SelectorRegistry = {
  ...
  "comments-section-canary": {
    name: "comments-section-canary",
    layers: [
      {
        type: "css",
    ...
    layers: [
      {
        ...
        description: "Name text span within comment meta (aria-hidden copy for display)",
      },
      {
        type: "css",
        selector: ".comments-post-meta__name-text a",
        description: "Name link within comment meta",
      },
      {
        type: "xpath",
        selector: ".//a[contains(@href,'/in/')]/span[@aria-hidden='true'] | .//a[contains(@class,'comment')][contains(@href,'/in/')]",
        description: "Profile link span or anchor with /in/ href",
      },
      {
        type: "heuristic",
    ...
    layers: [
      {
        ...
        description: "Headline element within comment meta",
      },
      {
        type: "css",
        selector: ".comments-comment-item__post-meta .t-12",
        description: "Small text element in comment post meta",
      },
      {
        type: "xpath",
        selector: ".//span[contains(@class,'headline')] | .//span[contains(@class,'t-12')][contains(@class,'t-black--light')]",
        description: "Headline class or small muted text below name",
      },
    ],
    canary: false,
  },
    ...
    layers: [
      {
        ...
        description: "Profile anchor within comment meta name",
      },
      {
        type: "css",
        selector: "a.comments-post-meta__profile-link",
        description: "Profile link class on comment meta anchor",
      },
      {
        type: "xpath",
        selector: ".//a[contains(@href,'/in/')][1]",
    ...
    layers: [
      {
        ...
        description: "Update components text within comment main content",
      },
      {
        type: "css",
        selector: ".comments-comment-item__main-content span.break-words",
        description: "Break-words span within comment content",
      },
      {
        type: "xpath",
        selector: ".//div[contains(@class,'main-content')]//span[contains(@class,'break-words')] | .//div[contains(@class,'comment-item__main')]//span[@dir='ltr']",
        description: "Text span within comment main content area",
      },
      {
        type: "heuristic",
        selector: ".//div[contains(@class,'main-content')]//span[string-length(normalize-space()) > 10]",
        description: "Longest text span within main content (>10 chars)",
      },
    ],
    canary: false,
  },
    ...
    layers: [
      {
        ...
        description: "Time element with timestamp class",
      },
      {
        type: "css",
        selector: ".comments-comment-item__timestamp",
        description: "Timestamp class element",
      },
      {
        type: "xpath",
    ...
    layers: [
      {
        ...
        description: "Reply item class (nested comment)",
      },
      {
        type: "css",
